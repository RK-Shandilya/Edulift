...
const Signin = () => {
  return (
    <div className='w-full h-screen overflow-hidden flex flex-col p-8 lg:pl-18 gap-10 text-white'
    style={{
    ...
    >
      ...
      <div className='flex flex-col w-full max-w-md gap-8 rounded-xl border border-white/10 p-4'>
        <h1 className='lg:text-4xl text-2xl font-bold inria-serif-bold'>SIGN IN TO EDULIFT</h1>
        <p className='text-md'>Create an account or <span className='text-blue-400 hover:text-blue-300 cursor-pointer'>Login</span></p>

        <div className='flex flex-col md:flex-row md:justify-between gap-8 text-black'>
